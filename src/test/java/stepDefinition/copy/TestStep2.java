package stepDefinition.copy;
	...
	public class TestStep2 {
		...
		public void userCreateMethod(){
			...
			System.out.println("Usser Method Created2");
		}
		
		@When("^Function is created$")
		public void userFunctionCreated(){
			
			System.out.println("Usser Function Created2");
		}
		@And("^System.out.println statement is writted$")
		public void PrintStatementWritten(){
			
			System.out.println("Print Statement Written2");
		}
		@Then("^Hello World is printed$")
		public void Print(){
			
			System.out.println("Print Hello World2");
		}
